...
if(USE_HTTPS)
	...
	elseif(USE_HTTPS STREQUAL "WolfSSL")
		if(NOT WOLFSSL_FOUND)
			message(FATAL_ERROR "Asked for WolfSSL TLS backend, but it wasn't found")
		endif()

		set(GIT_WOLFSSL 1)
		list(APPEND LIBGIT2_SYSTEM_INCLUDES ${WOLFSSL_INCLUDE_DIR})
		list(APPEND LIBGIT2_SYSTEM_LIBS ${WOLFSSL_LIBRARIES})
		list(APPEND LIBGIT2_PC_LIBS ${WOLFSSL_LDFLAGS})
		list(APPEND LIBGIT2_PC_REQUIRES "wolfssl")
